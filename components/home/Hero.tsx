...
const Hero = () => {
    ...
    return (
        <header className='bg-black text-white flex flex-col items-center bg-[url("https://assets.prebuiltui.com/images/components/hero-section/hero-background-image.png")] bg-cover bg-center bg-no-repeat pb-10'>
                ...
                <div className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="md:hidden absolute top-6 right-6 bg-gray-900 rounded-full
                            hover:bg-gray-800 text-white p-2  transition"
                        >
                            <svg
                        ...
                        <div className="flex flex-col items-center gap-16 md:flex-row">
                            ...
                            <a href="#features" onClick={() => setMobileOpen(false)} className="text-stone-50 hover:text-[#a5fe64]">
                                Features
                            </a>
                            <a href="#contact" onClick={() => setMobileOpen(false)} className="text-stone-50 hover:text-[#a5fe64] md:mr-6">
                                Contact
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-2.5">
                        <div className='p-[0.5px] rounded-full bg-linear-to-r from-white to-[#999999]/0'>
                            {user ? (
                                <Link
                                    href="/dashboard"
                                    className="hidden md:flex items-center gap-2 bg-[#A6FF5D] text-gray-800
                                        font-medium px-4 py-2.5 rounded-full text-sm cursor-pointer
                                        hover:bg-[#84f12a] hover:text-gray-700 transition-all duration-200"
                                >
                                    Go to Dashboard
                                </Link>
                                ...
                                <Link
                                    ...
                                    className="hidden md:flex items-center gap-2 bg-[#A6FF5D] text-gray-800
                                        font-medium px-4 py-2.5 rounded-full text-sm transition cursor-pointer group"
                                >
                        ...
                        {!user && (
                            <Link
                                ...
                                className="hidden md:block px-6 py-2 border border-stone-50 active:scale-95
                                    hover:bg-slate-50 transition-all rounded-full text-stone-50
            ...
            <div className="rainbow relative z-0 bg-white/15 overflow-hidden p-px flex items-center justify-center rounded-full transition duration-300 active:scale-100 mt-28 md:mt-32">
                <button className="flex items-center justify-center gap-3 pl-4 pr-6 py-3 text-white rounded-full font-medium bg-gray-900/80 backdrop-blur">
                    <div className="relative flex size-3.5 items-center justify-center">
                        ...
                        <span className="relative inline-flex size-2 rounded-full bg-[]"></span>
                    </div>
                    <span className='text-xs'>Designed for build resumes</span>
                </button>
            </div>

            <h1 className="text-4xl md:text-[64px]/[82px] text-center max-w-4xl mt-5 bg-clip-text leading-tight px-4">
                Create, edit and download professional resumes with <span className="text-[#A6FF5D]">AI-powered</span> assistance.
            </h1>
            ...
            <h2 className="mt-10 text-xl text-stone-200">Recommended by</h2>

            <div className="flex flex-row items-center justify-center gap-10 md:gap-20 mx-auto mt-10 px-4 flex-wrap">
            ...
            <button
                className='scroll-down flex flex-col items-center gap-4 mt-20 animate-bounce cursor-pointer'
                onClick={() => {
